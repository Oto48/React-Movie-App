  ...
  const register = async (event) => {
    ...
    if (Object.keys(errors).length === 0) {
      ...
      try {
        ...
        await axios.post(
          "https://cors-anywhere.herokuapp.com/https://react-movie-app-1fej.onrender.com/register",
    ...
    if (!Object.keys(errors).length) {
      try {
        ...
        const response = await axios.post(
          "https://cors-anywhere.herokuapp.com/https://react-movie-app-1fej.onrender.com/login",
          formData,
          {
